 ...
 "cells": [
  {
   "cell_type": "code",
   "execution_count": 2,
   "id": "27ee39b7-65ab-4306-a946-18b8cae25235",
   "metadata": {},
   "outputs": [
    {
     "name": "stdout",
     ...
     "text": [
      ...
      "1  RES_ORD_930.0  03/01/2023   Tuesday  18:32  MAIN COURSES  Boiled Rice with Designer Stew - Ayamase         1             8.0          8.0       2.80         5.20  Delivery    Card        No\n",
      "2  RES_ORD_928.0  03/01/2023   Tuesday  18:08  MAIN COURSES                                Fried Rice         1             7.5          7.5       2.62         4.88  Delivery    Card        No\n",
      "✅ Clean data: 4,361 rows  (removed cancelled orders)\n",
      "   Orders    : 1,398\n",
      "   Products  : 62\n",
      "   Categories: 8\n",
      "   Revenue   : £38,480\n",
      "   Profit    : £25,018\n",
      "   Dates     : 2023-01-03 → 2025-12-31\n",
      "✅ Saved transactions to SQLite: /Users/komudigimhani/Desktop/SmartRetail360/data/smartretail.db\n",
      "✅ RFM built for 1,398 orders\n",
      "\n",
      ...
      "Lapsed        192\n",
      "Low Value      29\n",
      "✅ KMeans done: K=4, Silhouette=0.311\n",
      "Cluster\n",
      "0    603\n",
      "1    199\n",
      "2    284\n",
      "3    312\n",
      "✅ KMeans model saved!\n",
      "✅ Forecast model — MAE: £73 | MAPE: 318.4%\n",
      "✅ Forecast model saved!\n",
      "Cancellation rate: 0.5%\n",
      "✅ Cancellation model AUC-ROC = 0.7971\n",
      "              precision    recall  f1-score   support\n",
      "\n",
      "      Active       1.00      0.99      0.99       872\n",
      "   Cancelled       0.17      0.20      0.18         5\n",
      "\n",
      "    accuracy                           0.99       877\n",
      "   macro avg       0.58      0.60      0.59       877\n",
      "weighted avg       0.99      0.99      0.99       877\n",
      "\n",
      "✅ Cancellation model saved!\n",
      "✅ Sentiment analysed for 63 menu items\n",
      "Sentiment\n",
      "Neutral     62\n",
      "Positive     1\n",
      "✅ All data saved to SQLite: /Users/komudigimhani/Desktop/SmartRetail360/data/smartretail.db\n",
      "✅ EDA charts saved to reports/\n",
      "\n",
      "═══════════════════════════════════════════════════════\n",
      "  ✅  SMARTRETAIL360 PIPELINE COMPLETE!\n",
      "═══════════════════════════════════════════════════════\n",
      "  ✅ KMeans Segmentation\n",
      "  ✅ Revenue Forecast\n",
      ...
      "  2. cd /Users/komudigimhani/Desktop/SmartRetail360\n",
  ...
  },
  {
   ...
   "id": "952df2d1-e1e2-46c8-b271-d2033d5d3b1d",
   "metadata": {},
   "outputs": [],
   "source": []
  }
